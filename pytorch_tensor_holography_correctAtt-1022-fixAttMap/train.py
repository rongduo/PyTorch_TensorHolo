...
def main():
    ...
    # create dataloader
    train_loader = get_dataloader('train', config,  num_workers=config.num_workers)
    val_loader = get_dataloader('test',  config, num_workers=config.num_workers)
