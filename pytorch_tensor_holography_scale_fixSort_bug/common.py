...
class Config(object):
    ...
    def _add_basic_config_(self, parser):
        ...
        group.add_argument('--proj_dir', type=str, default="/jixie/yujie_codes/3DHOLOGRAM", help="path to project folder where models and logs will be saved")
        group.add_argument('--holo_data_root', type=str, default='/jixie/yujie_data/MIT_CGH_4K')
    ...
    def _add_network_config_(self, parser):
        ...
        group.add_argument('--n_layers', type=int, default=30, help="the amount of the layers within the residual network")
